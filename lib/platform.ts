...
export const labels: Record<string, string> = { published: '공개', draft: '임시저장', archived: '보관', active: '활성', inactive: '비활성', paid: '결제 완료', pending: '대기', approved: '승인 완료', returned: '보완 요청', changes_requested: '보완 요청', submitted: '검토 대기', rejected: '반려', completed: '완료', cancelled: '취소', refunded: '환불 완료', recruiting: '모집 중', closed: '모집 마감', scheduled: '예정', free: '무료 클래스', paid_class: '유료 클래스', digital: '디지털 상품' };
export type Field = {
    key: string;
    label: string;
    type?: string;
...
export const sections: Section[] = [
    ...
    { key: 'missions', title: '미션 관리', group: '클래스 관리', table: 'curriculum_missions', fields: [f('lesson_id', '학습', 'lesson', true), f('title', '미션 제목', 'text', true), f('instructions', '미션 안내', 'textarea'), f('submission_type', '제출 방식', 'select', false, ['text', 'link', 'mixed']), f('is_required', '필수 미션', 'checkbox'), f('is_published', '공개', 'checkbox')] },
    ...
    { key: 'questions', title: '질문함', group: '클래스 관리', table: 'edu_questions', fields: [f('answer', '답변', 'textarea', true), f('status', '상태', 'select', false, ['open', 'answered'])] },
