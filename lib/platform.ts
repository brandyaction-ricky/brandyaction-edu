...
export const sections: Section[] = [
    { key: 'products', title: '상품 관리', group: '클래스 관리', table: 'courses', fields: [f('title', '상품명', 'text', true), f('course_code', '상품 코드', 'text', true), f('slug', '페이지 주소', 'text', true), f('category', '상품 유형', 'select', false, ['free', 'paid_class', 'digital']), f('summary', '한 줄 소개'), f('description', '상세 설명', 'textarea'), f('detail_html', '상세 본문 · HTML', 'textarea'), f('detail_images', '상세 이미지 목록', 'json'), f('instructor_name', '강사명'), f('regular_price', '정가', 'number'), f('list_price', '판매가', 'number'), f('duration_label', '수강 기간'), f('schedule_label', '일정 안내'), f('status', '공개 상태', 'select', false, ['draft', 'published', 'archived']), f('thumbnail_url', '목록 이미지', 'image'), f('seo_title', '검색 제목'), f('seo_description', '검색 설명', 'textarea')] },
