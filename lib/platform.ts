...
export const sections: Section[] = [
    ...
    { key: 'tags', title: '고객 태그', group: '고객 관리', table: 'crm_tags', fields: [f('name', '태그명', 'text', true), f('color', '태그 색상', 'color'), f('description', '설명', 'textarea'), f('tag_kind', '부여 방식', 'select', true, ['automatic', 'manual']), f('rule_key', '조건 행동', 'select', false, ['free_lesson_1', 'free_lesson_2', 'free_lesson_3', 'paid_customer', 'mission_completed', 'signed_up']), f('is_active', '사용 상태', 'checkbox')] },
