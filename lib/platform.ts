...
export const sections: Section[] = [
    { key: 'conversion', title: '전환 관리', group: '고객 관리', table: 'edu_conversion_cases', readOnly: true, fields: [] },
    { key: 'products', title: '상품 관리', group: '클래스 관리', table: 'courses', fields: [f('title', '상품명', 'text', true), f('course_code', '상품 코드', 'text', true), f('slug', '페이지 주소', 'text', true), f('category', '상품 유형', 'select', false, ['free', 'paid_class', 'digital']), f('summary', '한 줄 소개'), f('description', '상세 설명', 'textarea'), f('detail_html', '상세 본문 · HTML', 'textarea'), f('detail_html_document', '상세 HTML 원본', 'textarea'), f('detail_images', '상세 이미지 목록', 'json'), f('instructor_name', '강사명'), f('instructor_bio', '강사 소개', 'textarea'), f('instructor_approved', '강사 소개 공개 승인', 'checkbox'), f('public_keywords', '공개 검색 키워드'), f('provided_items', '제공 항목', 'textarea'), f('usage_notes', '이용 유의사항', 'textarea'), f('participation_guide', '신청 완료 참여 안내', 'textarea'), f('regular_price', '정가', 'number'), f('list_price', '판매가', 'number'), f('duration_label', '수강 기간'), f('schedule_label', '일정 안내'), f('status', '공개 상태', 'select', false, ['draft', 'published', 'archived']), f('thumbnail_url', '목록 이미지', 'image'), f('seo_title', '검색 제목'), f('seo_description', '검색 설명', 'textarea'), f('cta_price_label', 'CTA 왼쪽 문구'), f('cta_label', 'Button Label'), f('cta_url', 'Destination URL'), f('cta_color', 'CTA Button Color'), f('meta_pixel_id', 'Meta Pixel ID')] },
    ...
    { key: 'articles', title: '아티클', group: '콘텐츠 관리', table: 'articles', fields: [f('title', '제목', 'text', true), f('slug', '페이지 주소', 'text', true), f('category_id', '카테고리', 'article-category'), f('summary', '요약', 'textarea'), f('cover_image_path', '대표 썸네일', 'image'), f('cover_image_alt', '대표 썸네일 대체 문구'), f('content_type', '종류', 'select', false, ['column', 'video']), f('content_blocks', '아티클 본문', 'blocks'), f('video_url', '영상 URL', 'url'), f('status', '공개 상태', 'select', false, ['draft', 'published', 'hidden']), f('is_featured', '대표 노출', 'checkbox')] },
    ...
    { key: 'analytics', title: '전체 유입 성과', group: '마케팅 관리', table: 'customer_journey_events', readOnly: true, fields: [] },
    { key: 'metrics', title: '실측 데이터 관리', group: '마케팅 관리', table: 'site_settings', fields: [f('key', '기간 / 캠페인 코드', 'text', true), f('value', '지표 (JSON)', 'json', true)] },
