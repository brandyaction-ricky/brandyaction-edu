...
export const JEV_V4_QUESTIONS = {
  ...
  observable_stage: { type: 'choice', instructions: '유료 교육에 관해 직접 표현된 단계만 고르세요. 무료 자료만 요청했거나 유료 관심을 명시적으로 부정했다면 no_purchase_signal입니다. “무료 영상 후 유료 교육을 결정”한다고 직접 말한 경우에만 future_consideration_after_free_content입니다. 무료 자료 접근, 유료에 대한 단순 부정 또는 결제창 노출만으로 유료 관심·신청·결제를 추정하지 마세요. 유료 구매 의도·준비도 점수를 만들지 마세요.', criteria: {
