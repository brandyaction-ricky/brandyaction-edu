            ...
            {user ? (
              <>
                ...
                <div className="profile-menu-wrap" ref={profileMenuRef}>
                  ...
                  {profileMenuOpen && (
                    <nav id="profile-menu" className="profile-menu" aria-label="내 프로필 메뉴">
                      ...
                      <button type="button" disabled={pending} onClick={() => { setProfileMenuOpen(false); void logout(); }}><LogOut aria-hidden="true" />로그아웃</button>
                    </nav>
                  )}
                </div>
              </>
