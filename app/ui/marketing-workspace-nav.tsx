...
const destinations = [
  ['conversion', '문의·구매 기록', '카톡 문의를 보고 구매 여부 기록'],
...
const guides: Record<string, { heading: string; summary: string; steps: readonly string[]; caution?: string }> = {
  conversion: {
    heading: '카톡 문의를 기록하고 답변을 준비해요',
    summary: '문의 내용을 붙여넣으면 구매에 관심이 있는지, 무료 자료를 못 찾는지 나눠 보여줍니다.',
    steps: ['카톡 문의를 붙여넣으려면 ‘구매 전 문의 검토’를, 모집 정보를 보려면 ‘모집 설정·구매·후속 안내’를 고르세요.', '문의 내용을 넣고 판정과 답변 초안을 읽어보세요.', '필요한 기록을 저장하고, 실제 결제 여부는 확인한 뒤 적으세요.'],
    caution: '판정은 답변을 준비하는 참고입니다. 실제 고객에게 보낼 말은 직원이 확인하세요.',
  },
  landing: {
