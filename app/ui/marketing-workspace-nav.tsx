...
const guides: Record<string, { heading: string; summary: string; steps: readonly string[]; caution?: string }> = {
  conversion: {
    ...
    summary: '문의 내용을 붙여넣으면 무료 자료 이용 문제인지, 유료 교육에 관심이 있는 말인지 나눠 보여줍니다.',
    steps: ['카톡 문의를 붙여넣으려면 ‘구매 전 문의 검토’를, 모집 정보를 보려면 ‘모집 설정·구매·후속 안내’를 고르세요.', '무엇 때문에 문의했는지와 답변 예시를 읽어보세요.', '필요한 기록을 저장하고, 실제 결제 여부는 확인한 뒤 적으세요.'],
