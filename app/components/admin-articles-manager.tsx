...
import { ArrowDown, ArrowLeft, ArrowUp, BookOpen, Check, ChevronRight, Download, Eye, FileImage, FileText, GripVertical, ImagePlus, LoaderCircle, Paperclip, Pencil, Plus, Save, Search, Settings2, Star, Trash2, Upload } from "lucide-react";
...
function emptyArticle(categoryId = ""): Article {
  return { id: "", categoryId, categoryName: "", slug: "", title: "", summary: "", blocks: [{ id: crypto.randomUUID(), type: "paragraph", text: "" }], attachments: [], coverImagePath: "", coverImageUrl: "", coverImageAlt: "", status: "draft", isFeatured: false, seoTitle: "", seoDescription: "", scheduledAt: "", publishedAt: "", createdAt: "", updatedAt: "" };
}
