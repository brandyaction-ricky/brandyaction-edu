...
function ArticleList(props: { data: AdminPayload; visible: Article[]; query: string; setQuery: (value: string) => void; categoryFilter: string; setCategoryFilter: (value: string) => void; categoryDraft: { id: string; name: string; description: string }; setCategoryDraft: (value: { id: string; name: string; description: string }) => void; saveCategory: () => void; deleteCategory: (category: ArticleCategory) => void; openNew: () => void; openEdit: (article: Article) => void; quickUpdate: (article: Article, changes: Partial<Article>, success: string) => void; removeArticle: (article: Article) => void; saving: boolean }) {
