...
export function AdminBannerManager() {
  ...
  return <div className="admin-editor-wrap">
    <section className="admin-panel banner-library">
      <div className="form-card-head"><div><h2>랜딩 이미지 배너 <small className="banner-count">{banners.length}개</small></h2><p>등록·수정 후 메인 페이지에 즉시 반영되며, 2개 이상이면 등록 순서대로 자동 슬라이드됩니다.</p></div><button className="admin-primary" onClick={() => open()}><Plus/> 배너 추가</button></div>
