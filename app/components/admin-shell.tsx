...
const navGroups = [
  ...
  { label:"교육 운영",items:[{ id:"products",label:"상품 관리",href:"/admin/products",icon:BookOpen },{ id:"cohorts",label:"기수·회차 관리",href:"/admin/cohorts",icon:GraduationCap },{ id:"submissions",label:"과제 검토",href:"/admin/submissions",icon:CheckSquare2 },{ id:"reviews",label:"후기 관리",href:"/admin/reviews",icon:MessageSquareText }] },
