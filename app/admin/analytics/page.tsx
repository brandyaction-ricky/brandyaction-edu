...
export default async function AdminAnalytics({ searchParams }: { searchParams: Promise<{ period?: string; notice?: string }> }) {
  const operator = await getAdminUser();
  if (!operator || operator.role !== "admin") redirect("/login?error=admin_required");
