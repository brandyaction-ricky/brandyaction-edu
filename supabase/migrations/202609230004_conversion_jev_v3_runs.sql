...
create table public.edu_conversion_jev_v3_runs (
...
create index edu_conversion_jev_v3_case_created on public.edu_conversion_jev_v3_runs(case_id,created_at desc);

alter table public.edu_conversion_jev_v3_runs enable row level security;
revoke all on public.edu_conversion_jev_v3_runs from public,anon,authenticated,service_role;
grant select,insert,update on public.edu_conversion_jev_v3_runs to service_role;
