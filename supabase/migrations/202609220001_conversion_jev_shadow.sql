...
alter table public.edu_conversion_runs drop constraint edu_conversion_runs_provider_check;
alter table public.edu_conversion_runs drop constraint edu_conversion_runs_result_check;
alter table public.edu_conversion_runs
  add constraint edu_conversion_runs_provider_check check (provider in ('mock','jev')),
  add constraint edu_conversion_runs_result_check check (
    jsonb_typeof(result)='object'
    and result->>'mode'=provider
    and result->'requires_human_review'='true'::jsonb
  );
