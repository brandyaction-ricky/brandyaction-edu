...
test('mock cannot run in production, contradictory environment, or unknown environment', async () => {
  const environments = [{ ...env, NEXT_PUBLIC_APP_ENV: 'production' }, { ...env, VERCEL_ENV: 'production' }, { ...env, NEXT_PUBLIC_APP_ENV: 'production', VERCEL_ENV: 'preview' }, { ...env, NEXT_PUBLIC_APP_ENV: undefined }, { ...env, EDU_CONVERSION_MOCK_ENABLED: 'false' }];
