...
const result = { contract_version: 4, model: 'jev-test', decisions: {} };
const request = (origin = 'https://edu.example') => new Request('https://edu.example/api/conversion/jev-v4', {
...
function harness(options = {}) {
  ...
  const handlers = load('../app/api/conversion/jev-v4/route.ts', {
...
test('v4 requires DEV, same origin, and operator before accessing inquiry data', async () => {
