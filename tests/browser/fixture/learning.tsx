...
const course: Row = { id: 'course', slug: 'qa-course', title: '모집 상태 클래스', category, status: 'published', list_price: category === 'free' ? 0 : 10000, description: '상세 안내', duration_label: '4주', schedule_label: '매주 화요일', metadata: { [params.has('inline') ? 'detail_html' : 'detail_html_document']: body, ...(params.has('custom') ? { cta_url: url, cta_label: '외부 신청하기' } : {}) } };
