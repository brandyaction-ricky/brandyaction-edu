...
// Match the live course-1786885941837 CTA structure, including decorative arrows.
const decoratedBody = markedBody.replace('<a id="legacy-cta" href="#">무료강의 대기방 입장</a>', '<a id="legacy-cta" href="#"><span>무료강의 대기방 입장</span><span>→</span></a>');
const markedProductBody = category === 'free' ? decoratedBody : decoratedBody.replace('무료강의 대기방 입장', '구매하기').replace('무료강의 참여 안내', '자료 이용 안내');
